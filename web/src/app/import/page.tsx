  ...
  return (
    <>
      ...
      <p className="subtitle">
        ...
        Último post, Seguidores, País</strong> (España, Reino Unido, Estados Unidos o Canadá; obligatorio). El autopiloto de mañana las validará, puntuará y
      ...
      <form action={importarProspectosAction} className="card">
        <textarea
          name="csv"
          placeholder={'Nombre\tURL perfil\tCargo\tEmpresa\tBio\tÚltimo post\tSeguidores\tPaís\nAna Pérez\thttps://www.linkedin.com/in/anaperez\tCoach de negocio\t...'}
        />
